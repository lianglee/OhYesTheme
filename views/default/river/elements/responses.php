...
?>
<?php //	<span class="elgg-river-comments-tab"><?php echo elgg_echo('comments');</span>  ?>
...
// inline comment form
$form_vars = array('id' => "comments-add-{$object->getGUID()}", 'class' => 'hidden ohyestheme-activity-response');
